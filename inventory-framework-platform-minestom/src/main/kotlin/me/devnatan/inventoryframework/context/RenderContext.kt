...
class RenderContext @ApiStatus.Internal constructor(
    id: UUID,
    root: View,
    config: ViewConfig,
     ...
     */
    fun slot(slot: Int, item: ItemStack): MinestomIemComponentBuilder {
     ...
     * @return An item builder to configure the item.
     */
    fun slot(row: Int, column: Int, item: ItemStack?): MinestomIemComponentBuilder {
     ...
     * @return An item builder to configure the item.
     */
    fun layoutSlot(character: Char, item: ItemStack?): MinestomIemComponentBuilder {
