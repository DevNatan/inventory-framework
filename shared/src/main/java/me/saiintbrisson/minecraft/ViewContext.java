...
public interface ViewContext extends VirtualView {
	 ...
	 */
	@UnknownNullability("Value can be null if the user provides a null property value") <T> T get(@NotNull String key);
	 ...
	 * @see #get(String)
	 */
	@UnknownNullability("Value can be null if the user provides a null property value") <T> T get(@NotNull String key, @NotNull Supplier<T> defaultValue);
