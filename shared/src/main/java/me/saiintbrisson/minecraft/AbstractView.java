...
public abstract class AbstractView extends AbstractVirtualView {
	...
	final void init() {
		...
		if (getLayout() != null) {
			...
			reservedItemsCount = getReservedItems() == null ? 0 : getReservedItems().size();
	 ...
	 */
	@Override
	public final @NotNull ViewItem availableSlot(Object item) throws InitializationException {
		ensureNotInitialized();
		return super.availableSlot(item);
	}
