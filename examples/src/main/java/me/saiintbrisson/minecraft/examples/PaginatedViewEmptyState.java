...
/**
 * Adds an item to signal that there are no items available in pagination.
 * Open the View with items in your inventory and then without.
 */
public final class PaginatedViewEmptyState extends PaginatedView<ItemStack> {
	...
	protected void onRender(@NotNull ViewContext context) {
		 ...
		 */
		if (inventoryContents.isEmpty())
			context.slot(13, new ItemStack(Material.BEDROCK));
	}
