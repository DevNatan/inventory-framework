...
public abstract class PlatformView<
	...
	TSlotClickContext extends IFSlotClickContext> implements RootView {
	 ...
	 * @return A state computed with an initial opening data value.
	 */
	protected final <V> State<V> initialState(@NotNull Class<? extends V> stateClassType) {
		throw new UnsupportedOperationException();
	}
	...
	protected void onOpen(TOpenContext ctx) {
	}
	 ...
	 */
	@ApiStatus.OverrideOnly
	protected void onRender(TRenderContext ctx) {
	}
	 ...
	 */
	@ApiStatus.OverrideOnly
	protected void onUpdate(TContext ctx) {
	}
	 ...
	 */
	@ApiStatus.OverrideOnly
	protected void onClose(TContext ctx) {
	}
	 ...
	 */
	@ApiStatus.OverrideOnly
	protected void onClick(TSlotClickContext ctx) {
	}
