...
public class ViewFrame extends IFViewFrame<ViewFrame> implements FeatureInstaller<ViewFrame> {
	...
	@Override
	public void open(@NotNull Class<? extends RootView> viewClass, @NotNull Iterable<Viewer> viewers, Object initialData) {
	 ...
	 */
	public void open(@NotNull Class<? extends RootView> viewClass, @NotNull List<Player> players) {
	 ...
	 */
	public void open(
		@NotNull Class<? extends RootView> viewClass, @NotNull List<Player> players, Object initialData) {
