...
public class PlatformUtils {
    ...
    public static ElementFactory getFactory() {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to use fallback component factory on classpath.", e);
        }
    ...
    private static void checkIfPlatformWorksInCurrentPlatform() {
        ...
        throw new IllegalStateException("We found a component factory on the classpath but it is not usable on this "
    ...
    private static ElementFactory fallbackFactory()
        ...
        final Class<?> clazz = Class.forName("me.devnatan.inventoryframework.internal.BukkitInventoryFactory");
